    ...
    <div class="card-body">
      ...
      <form id="register-form" action="" method="POST">
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="name" value="<?php if (isset($_POST['name'])) echo htmlentities($_POST['name']); ?>" placeholder="Name">
        ...
        <div class="input-group mb-3">
          <input type="email" class="form-control" name="email" <?php if (isset($_POST['email'])) echo htmlentities($_POST['email']); ?> placeholder="Email">
